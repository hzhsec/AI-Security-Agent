...
6. 所有命令使用 **Linux bash** 语法，不得混入 PowerShell / cmd 命令
"""
...
6. 所有命令使用 **Windows cmd 或 PowerShell** 语法，不得混入 Linux bash 命令
   - ❌ 错误：`cat /etc/passwd`、`grep`、`ls`、`chmod`
   - ✅ 正确：`type C:\\Windows\\System32\\...`、`findstr`、`dir`、`icacls`
"""
